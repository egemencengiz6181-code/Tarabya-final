...
function PhaseCard({ title, text, index }: { title: string; text: string; index: number }) {
 ...
 whileInView="visible"
 viewport={{ once: true }}
 className="relative p-8 rounded-3xl border border-black/5 dark:border-white/5 bg-black/[0.03] dark:bg-white/[0.03] bg-background/70 hover:border-[#E21F26]/20 hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-all duration-500 group"
 >
...
export default function ServiceSlugContent({ slug, images, i18n }: Props) {
 ...
 <section className="max-w-5xl mx-auto px-6 pt-12 pb-24">
  ...
  <div className="px-4 py-2 rounded-xl bg-background/80 bg-background/80 border border-black/10 dark:border-white/10 inline-flex">
 ...
 <section className="max-w-5xl mx-auto px-6 pb-32">
  ...
  whileInView="visible"
  viewport={{ once: true }}
  className="lg:sticky lg:top-32 p-8 rounded-3xl border border-black/5 dark:border-white/5 bg-black/[0.03] dark:bg-white/[0.03] bg-background/70"
  >
 ...
 <section className="max-w-5xl mx-auto px-6 pb-32">
  ...
  <div className="absolute bottom-6 left-6 px-4 py-2 rounded-xl bg-background/80 bg-background/80 border border-white/10 inline-flex items-center gap-2">
