...
function StatCard({ icon: Icon, label, color }: { icon: React.ElementType; label: string; color: string }) {
 return (
 <div className="flex items-center gap-3 p-5 rounded-2xl border border-black/[0.06] dark:border-white/[0.06] bg-black/[0.02] dark:bg-white/[0.02] bg-background/70">
...
export default function RehberlikPage() {
 ...
 <section ref={heroRef} className="relative min-h-[85vh] flex items-center pt-32 pb-20 px-6">
  ...
  <div>
   ...
   className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#2E3192]/30 bg-[#2E3192]/[0.08] bg-background/70 mb-8"
   >
  ...
  <motion.div variants={fadeUp} custom={4} initial="hidden" animate="show" className="relative">
   ...
   <div className="relative rounded-3xl border border-black/[0.07] dark:border-white/[0.07] bg-black/[0.03] dark:bg-white/[0.03] bg-background/95 p-8">
