...
export default function WorkDetailPage({
 ...
 <section className="relative h-[90vh] flex items-end overflow-hidden">
  ...
  <Link
  href={"/" as any}
  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/15 bg-white/5 bg-background/70 text-white/60 hover:text-white text-sm font-medium transition-all hover:border-white/30"
  >
