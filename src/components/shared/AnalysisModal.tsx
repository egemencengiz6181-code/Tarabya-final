...
function Overlay({ onClose }: { onClose: () => void }) {
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 bg-black/70 bg-background/70 z-[200]"
 onClick={onClose}
 />
 );
}
...
export default function AnalysisModal() {
 ...
 {typeof document !== "undefined" &&
  ...
  {open && (
   ...
   >
   <div
   className="relative w-full max-w-lg max-h-[90vh] bg-white dark:bg-[#0a0514] border border-[#E21F26]/20 rounded-3xl shadow-[0_0_80px_rgba(226,31,38,0.2)] overflow-y-auto"
