...
export default function HeroSection() {
 ...
 {/* Radial Accent Glow */}
 <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[600px] bg-primary/20 rounded-full pointer-events-none -z-10 animate-pulse" />
 ...
 <div className="container relative z-10 mx-auto px-6 text-center">
  ...
  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 bg-primary/5 bg-background/80 mb-8"
  >
  ...
  >
  {t('subtitle', { defaultValue: 'Tarabya Final Dershanesi, LGS\'de hedef liseye giden yolu açar.' })}
  </motion.p>
