...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({ title, description, badge }) => {
 ...
 <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-10">
  ...
  <motion.div
   ...
   viewport={{ once: true }}
   className="absolute bottom-4 right-2 sm:bottom-8 sm:right-2 md:-right-4 z-20 flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-2xl border border-black/10 dark:border-white/10 bg-white/60 dark:bg-black/60 bg-background/95 shadow-xl"
  >
