...
export default function MarketingBadges() {
 ...
 <div className="md:hidden w-full px-4 py-8">
  ...
  <motion.button
   ...
   whileTap={{ scale: 0.95 }}
   className={cn(
   "flex items-center gap-2 px-5 py-3 rounded-2xl border border-white/10 shadow-lg bg-background/80 cursor-pointer",
 ...
 <div className="hidden md:flex relative h-[500px] w-full items-center justify-center overflow-visible">
  ...
  <motion.button
   ...
   whileTap={{ scale: 0.95 }}
   className={cn(
   "absolute flex items-center gap-3 px-8 py-4 rounded-2xl border border-white/10 shadow-2xl bg-background/80 transition-all duration-500 group cursor-pointer",
