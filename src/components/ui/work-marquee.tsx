...
export default function WorkMarquee() {
 ...
 >
  ...
  >
   ...
   <div className="w-8 h-8 rounded-full border border-white/20 bg-white/10 bg-background/70 flex items-center justify-center opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
