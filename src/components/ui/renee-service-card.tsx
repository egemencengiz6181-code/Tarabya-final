...
export default function ReneeServiceCard({ title, description, slug, href, features }: ReneeServiceCardProps) {
 ...
 >
  {/* Front Face */}
  <div className="absolute inset-0 backface-hidden rounded-[32px] border border-black/10 dark:border-white/10 bg-gradient-to-br from-black/5 dark:from-white/5 to-primary/10 bg-background/95 p-8 flex flex-col items-center justify-center text-center overflow-hidden">
  ...
  {/* Back Face */}
  <div 
  className="absolute inset-0 backface-hidden rounded-[32px] border border-primary/30 bg-background/60 bg-background/95 p-8 flex flex-col justify-between [transform:rotateY(180deg)]"
  >
