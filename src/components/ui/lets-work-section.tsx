...
export default function LetsWorkSection() {
 ...
 <div className="max-w-7xl mx-auto px-6 relative z-10">
  ...
  viewport={{ once: true }}
  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-black/5 dark:border-white/5 bg-black/5 dark:bg-white/5 bg-background/80 mb-8"
  >
 ...
 {/* Background Ambience */}
 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/5 rounded-full pointer-events-none z-[1]" />
 </section>
 );
}
