...
function StoryCard({ s, i }: { s: typeof successStories[0]; i: number }) {
 ...
 <div className="relative h-full rounded-3xl border border-black/[0.035] dark:border-white/[0.035]">
  ...
  {/* glass body */}
  <div
  className="relative h-full flex flex-col gap-5 p-6 rounded-3xl bg-black/[0.03] dark:bg-white/[0.03] bg-background/95 transition-colors duration-500 overflow-hidden"
...
export default function ReferencesContent({
 ...
 <div className="max-w-7xl mx-auto px-6 relative z-10">
  ...
  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-black/10 dark:border-white/10 bg-black/[0.04] dark:bg-white/[0.04] bg-background/70 mb-8"
  >
  ...
  <div
   key={i}
   className="flex flex-col items-center gap-2 rounded-2xl border border-black/[0.07] dark:border-white/[0.07] bg-black/[0.03] dark:bg-white/[0.03] bg-background/95 p-5"
  >
